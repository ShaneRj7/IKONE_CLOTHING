<footer>
  <div class="container-fluid p-4 bg-dark footercontainer">
    <div class="contentrow row">
        <div class="contact col-md-6">
            <div class="col">
                <img src="/home/companydata/Logo.png" alt="">
            ...
            <div class="contactdetailscol col">
                <p>Contact Us</p>
                <p>ikone@gmail.com</p>
                <p>No 10, Anniwatte Road, Kandy.</p>
                <p>+94 777751862</p>
            </div>
        </div>
        <div class="newsletter col-md-4">
            ...
            <div class="div">
                <input type="text" name="" id="" placeholder="Enter your email" class="p-2">
                <button type="submit" class="subscribebtn p-2">Subscribe</button>
            </div>
        </div>
    </div>
    <div class="creditsrow row">
        <p>© 2023 IKONE. All rights reserved.</p>
    </div>
</footer>
